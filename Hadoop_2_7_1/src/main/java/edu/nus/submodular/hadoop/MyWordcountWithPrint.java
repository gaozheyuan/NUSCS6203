...
public class MyWordcountWithPrint {

	public MyWordcountWithPrint() {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		Job job = new Job(conf, "MyWordcountPrint");

		/* 啟動job的jar class 為MyWordcount */
		job.setJarByClass(MyWordcountWithPrint.class);
	...
	/*
	 * Mapper adapter: input key(LongWritable) , input value(Text) , output
	 * key(Text) , output value(IntWritable)
	 */
	...
	/*
	 * Reducer adapter: input key(Text) , input values(IntWritable) , output
	 * key(Text) , output value(IntWritable)
	 */
